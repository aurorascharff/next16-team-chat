...
import { getTracer, SpanKind, SpanStatusCode } from '../../server/lib/trace/tracer';
    ...
    const renderContext = {
        ...
        renderOpts: {
            ...
            experimental: {
                ...
                exposeTestingApi: pageRouteModule.isDev === true || nextConfig.experimental.exposeTestingApiInProductionBuild === true
            },
