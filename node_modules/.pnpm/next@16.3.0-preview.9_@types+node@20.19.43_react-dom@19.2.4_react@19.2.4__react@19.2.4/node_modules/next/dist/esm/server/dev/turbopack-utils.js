        ...
        case 'page':
            {
                ...
                try {
                    ...
                    if (dev) {
                        ...
                        if (entrypoints.global.document) {
                            hooks == null ? void 0 : hooks.subscribeToChanges(getEntryKey('pages', 'server', '_document'), /** includeIssues=*/ false, entrypoints.global.document, ()=>{
                                return {
                                    type: HMR_MESSAGE_SENT_TO_BROWSER.RELOAD_PAGE,
        ...
        case 'app-page':
            {
                ...
                if (dev) {
                    // TODO subscriptions should only be caused by the WebSocket connections
                    // otherwise we don't known when to unsubscribe and this leaking
                    hooks == null ? void 0 : hooks.subscribeToChanges(key, /** includeIssues=*/ true, route.rscHmrEndpoint, (change, hash)=>{
