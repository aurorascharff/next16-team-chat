 ...
 */ export class AppRouteRouteModule extends RouteModule {
   ...
   */ this.actionAsyncStorage = actionAsyncStorage;
        ...
        this._lazyUserland = new LazyModule(userland, (module)=>this._onUserlandLoaded(module));
   ...
   */ resolveHandlerFromUserland(method, userland) {
    ...
    async handle(req, context) {
        ...
        null);
        const requestStore = createRequestStoreForAPI(req, req.nextUrl, implicitTags, undefined, context.previewProps, context.renderOpts.hmrRefreshHash);
