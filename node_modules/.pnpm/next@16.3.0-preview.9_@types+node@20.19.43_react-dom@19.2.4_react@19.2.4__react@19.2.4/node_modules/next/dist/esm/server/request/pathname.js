...
import { makeHangingPromise, RENDER_STAGES_BY_DATA_KIND } from '../dynamic-rendering-utils';
            ...
            case 'prerender-runtime':
                {
                    ...
                    if (stagedRendering) {
                        ...
                        if (workUnitStore.isSessionShell) {
                            return makeHangingPromise(workUnitStore.renderSignal, workStore.route, '`pathname`');
                        } else {
