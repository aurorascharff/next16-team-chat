...
import { applyOwnerStack, makeDevtoolsIOAwarePromise, makeHangingPromise, RENDER_STAGES_BY_DATA_KIND } from '../dynamic-rendering-utils';
                        ...
                        case 'prerender-runtime':
                            {
                                ...
                                stagedRendering !== null && stagedRendering.finalStage !== null && stagedRendering.finalStage < postShellStage) {
                                    ...
                                    return makeHangingPromise(prerenderStore.renderSignal, workStore.route, 'dynamic "use cache"');
                                }
