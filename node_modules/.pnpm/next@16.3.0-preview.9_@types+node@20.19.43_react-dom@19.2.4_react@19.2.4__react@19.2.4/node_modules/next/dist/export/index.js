  ...
  Read more: https://nextjs.org/docs/messages/export-image-api`), "__NEXT_ERROR_CODE", {
    ...
    const renderOpts = {
        ...
        experimental: {
            ...
            exposeTestingApi: nextConfig.experimental.exposeTestingApiInProductionBuild === true
        },
    ...
    const pagesDataDir = options.buildExport ? (0, _path.join)(distDir, 'server', 'pages') : (0, _path.join)(outDir, '_next/data', buildId);
    ...
    const exportPagesInBatches = async (worker, exportPaths, renderResumeDataCachesByPage)=>{
        ...
        return (await Promise.all(batches.map(async (batch)=>worker.exportPages({
                ...
                clientAssetToken: nextConfig.supportsImmutableAssets ? '' : nextConfig.deploymentId,
                exportPaths: batch,
                ...
                dir,
                distDir,
                outDir: options.buildExport ? (0, _path.join)(distDir, 'server', 'pages') : outDir,
                nextConfig,
