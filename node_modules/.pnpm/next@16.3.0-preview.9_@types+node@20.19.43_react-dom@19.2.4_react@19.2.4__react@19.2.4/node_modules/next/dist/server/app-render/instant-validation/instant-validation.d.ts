 ...
 * */
export declare function collectStagedSegmentData(ComponentMod: FlightComponentMod, renderFlightStream: RenderToFlightStream, fullPageChunks: StageChunks, fullPageDebugChunks: Uint8Array[] | null, startTime: number, clientReferenceManifest: ClientReferenceManifest, createDebugChannel: () => DebugChannelPair | undefined): Promise<{
    cache: SegmentCache;
