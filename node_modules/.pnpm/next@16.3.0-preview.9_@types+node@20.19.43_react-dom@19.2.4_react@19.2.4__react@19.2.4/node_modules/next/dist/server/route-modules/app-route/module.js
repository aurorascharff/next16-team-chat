...
const _lazymodule = require("../../lib/lazy-module");
...
class AppRouteRouteModule extends _routemodule.RouteModule {
   ...
   */ this.actionAsyncStorage = _actionasyncstorageexternal.actionAsyncStorage;
        ...
        this._lazyUserland = new _lazymodule.LazyModule(userland, (module1)=>this._onUserlandLoaded(module1));
   ...
   */ resolveHandlerFromUserland(method, userland) {
    ...
    async handle(req, context) {
        ...
        null);
        const requestStore = (0, _requeststore.createRequestStoreForAPI)(req, req.nextUrl, implicitTags, undefined, context.previewProps, context.renderOpts.hmrRefreshHash);
