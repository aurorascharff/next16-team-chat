...
const _spanstore = require("./lib/trace/span-store");
...
class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        if ((dev || process.env.__NEXT_DEV_SERVER) && this.nextConfig.experimental.requestInsights) {
        ...
        ;
        globalThis.NEXT_CLIENT_ASSET_SUFFIX = this.nextConfig.supportsImmutableAssets || !this.deploymentId ? '' : `?dpl=${this.deploymentId}`;
        ...
        this.renderOpts = {
            ...
            experimental: {
                ...
                serverComponentsHmrCancellation: this.nextConfig.experimental.serverComponentsHmrCancellation,
                ...
                exposeTestingApi: this.dev === true || this.nextConfig.experimental.exposeTestingApiInProductionBuild === true
            },
    ...
    async handleRequest(req, res, parsedUrl) {
        ...
        const handleRequest = ()=>tracer.withPropagatedContext(req.headers, ()=>{
        ...
        if (!(0, _spanstore.isRequestInsightsEnabled)()) {
            return handleRequest();
        }
        const requestIdHeader = req.headers[_approuterheaders.NEXT_REQUEST_ID_HEADER];
        const requestId = typeof requestIdHeader === 'string' ? requestIdHeader : (0, _nanoid.nanoid)();
        const htmlRequestIdHeader = req.headers[_approuterheaders.NEXT_HTML_REQUEST_ID_HEADER];
        ...
        return (0, _requestinsightsidentity.runWithRequestInsightsIdentity)({
            requestId,
            htmlRequestId: typeof htmlRequestIdHeader === 'string' ? htmlRequestIdHeader : requestId,
            url: req.url
        }, handleRequest);
    }
        ...
        try {
            ...
            if (useMatchedPathHeader) {
                try {
                    ...
                    if ((0, _requestmeta.getRequestMeta)(req, 'isNextDataReq') && typeof (0, _requestmeta.getRequestMeta)(req, 'postponed') === 'string') {
            ...
            // client.
            if (!(0, _requestmeta.getRequestMeta)(req, 'hmrRefreshHash')) {
                (0, _requestmeta.addRequestMeta)(req, 'hmrRefreshHash', this.getServerComponentsHmrRefreshHash());
            }
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req, res, pathname, renderOpts: opts }, { components, query }) {
        ...
        !is404Page) {
            ...
            const routerPrefetch = prefetchHeaderValue !== undefined ? prefetchHeaderValue === '1' || prefetchHeaderValue === '2' || prefetchHeaderValue === '3' ? prefetchHeaderValue : undefined : // so we don't expect the header to be stripped by an intermediate layer.
            ...
            if (!matchesHash) {
                ...
                const url = new URL((0, _requestmeta.getRequestMeta)(req, 'initURL') || req.url || '', 'http://localhost');
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
        ...
        !hasPostponedState && !is404Page && !is500Page && pathname !== '/_error' && req.method !== 'HEAD' && req.method !== 'GET' && (typeof components.Component === 'string' || isSSG)) {
            res.statusCode = 405;
            res.setHeader('Allow', [
                'GET',
                'HEAD'
        ...
        if ((routeModule == null ? void 0 : routeModule.isDev) && (0, _utils1.isDynamicRoute)(pathname) && (components.getStaticPaths || isAppPath)) {
            ...
            if (isAppPath && this.nextConfig.cacheComponents) {
                ...
                if ((_pathsResults_prerenderedRoutes = pathsResults.prerenderedRoutes) == null ? void 0 : _pathsResults_prerenderedRoutes.length) {
                    ...
                    let perUrlFallbackRouteParams = null;
                    for (const route of pathsResults.prerenderedRoutes){
                        const fallbackRouteParams = route.fallbackRouteParams ?? [];
                        if (!(0, _routeregex.getRouteRegex)(route.pathname).re.test(urlPathname)) {
                            continue;
                        }
                        if (perUrlFallbackRouteParams === null || fallbackRouteParams.length < perUrlFallbackRouteParams.length) {
                            perUrlFallbackRouteParams = fallbackRouteParams;
                        }
                    }
                    if (perUrlFallbackRouteParams && perUrlFallbackRouteParams.length > 0) {
                        (0, _requestmeta.addRequestMeta)(req, 'fallbackParams', (0, _fallbackparams.createOpaqueFallbackRouteParams)(perUrlFallbackRouteParams));
                    }
                }
            }
        }
